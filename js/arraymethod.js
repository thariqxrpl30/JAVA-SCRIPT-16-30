...
let nilai = [
    ...
    {nama : "abdul", ipa :  93, bahasa : 95, matematika :  85},
    {nama : "zulkidul", ipa :  90, bahasa : 70, matematika :  80},
    {nama : "mikey", ipa :  93, bahasa : 90, matematika :  78},
];
...
// Array berisi string
let nama = ["rehan", "wangsaff", "bogor", "salah"];
